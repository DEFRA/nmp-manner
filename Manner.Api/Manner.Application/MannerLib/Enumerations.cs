...
namespace Manner.Application.MannerLib
{
    public class Enumerations
    {
        ...
        public enum ManureCategoryUserInterface
        {
            LiveStock = 1,
            Biosolids = 2,
            OtherOrganicMaterials = 3,
            Digestate = 4
        }
        ...
        public static string CropTypeRb209ToString(CropTypeRb209 enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.CropTypeRb209 [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static CropTypeRb209 CropTypeRb209FromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.CropTypeRb209"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.CropTypeRb209 [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.CropTypeRb209"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
        ...
        public enum ManureTypesRb209
        {
            ...
            GoatFYMOld = 11,
            GoatFYMFresh = 12,
            PoultryManure20Percent = 13,
            PoultryManure40Percent = 14,
            PoultryManure60Percent = 15,
            PoultryManure80Percent = 16,
            CattleSlurry2Percent = 17,
            CattleSlurry6Percent = 18,
            CattleSlurry10Percent = 19,
            DirtyWater = 20,
            SeparatedCattleSlurryStrainerBox = 21,
            SeparatedCattleSlurryWeepingWall = 22,
            SeparatedCattleSlurryMechanicalSeparator = 23,
            SeparatedCattleSlurrySolidPortion = 24,
            PigSlurry2Percent = 25,
            PigSlurry4Percent = 26,
            PigSlurry6Percent = 27,
            SeparatedPigSlurryLiquidPortion = 28,
            SeparatedPigSlurrySolidPortion = 29,
            BiosolidsDigestedCake = 30,
            BiosolidsThermallyDried = 31,
            BiosolidsLimeStabilised = 32,
            BiosolidsComposted = 33,
            GreenCompost = 34,
            GreenFoodCompost = 35,
            DigestateWholeFoodBased = 36,
            DigestateSeparatedLiquorFoodBased = 37,
            DigestateSeparatedFibreFoodBased = 38,
            DigestateWholeFarmSourced = 39,
            DigestateSeparatedLiquorFarmSourced = 40,
            DigestateSeparatedFibreFarmSourced = 41,
            PaperCrumbleChemicallyPhysicallyTreated = 42,
            PaperCrumbleBiologicallyTreated = 43,
            SpentMushroomCompost = 44,
            WaterTreatmentCake = 45,
            FoodWasteDairy = 46,
            FoodWasteSoftDrinks = 47,
            FoodWasteBrewing = 48,
            FoodWasteGeneral = 49
        }
        ...
        public static string ManureTypesRB209ToString(ManureTypesRb209 enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.ManureTypesRb209 [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static ManureTypesRb209 ManureTypesRB209FromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.ManureTypesRb209"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.ManureTypesRb209 [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.ManureTypesRb209"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
        ...
        public enum ManureTypes
        {
            ...
            DuckFYMFresh,
            DuckFYMOld,
            PoultryManure, // Was called LayerManure rename PoultryManure
            BroilerTurkeyLitter,
            DairySlurry,
            BeefSlurry,
            PigSlurry,
            CattleSlurryStrainerBoxLiquid,
            CattleSlurryWeepingWallLiquid,
            CattleSlurryMechanicallySeparatedLiquid,
            CattleSlurrySeparatedSolids,
            PigSlurrySeparatedSolids,
            PigSlurrySeparatedLiquid,
            DirtyWater,
            BiosolidsLiquidDigested,
            BiosolidsDigestedCake,
            BiosolidsThermallyDried,
            BiosolidsLimeStabilised,
            GreenCompost,
            PaperCrumble,
            WasteFoodGeneral,
            WasteFoodDairy,
            ...
            WasteFoodBrewing,
            HorseFYM,
            BiosolidsThermallyHydrolysed,
            GreenFoodCompost,
            PaperCrumbleChemicallyPhysicallyTreated,
            PaperCrumbleBiologicallyTreated,
            MushroomCompost,
            WaterTreatmentCake,
            DistilleryPotale,
            DistilleryEffluentSludge, // Was called DistilleryBioplantSludge rename DistilleryEffluentSludge
            BreweryWashWater, // Was called DistilleryEffluent renamed BreweryWashWater
            StrawMulch,
            GoatFYM,
            BiosolidsComposted,
            OtherSolidMaterials,
            OtherLiquidMaterials,
            CattleSlurry,
            DigestateWholeFoodBased,
            DigestateWholePigSlurryBased,
            DigestateWholeCattleSlurryBased,
            DigestateSeparatedLiquorFoodBased, // New from excel
            DigestateSeparatedFibreFoodBased, // New from excel
            DigestateWholeFarmSourced, // New from excel
            DigestateSeparatedLiquorFarmSourced, // New from excel
            DigestateSeparatedFibreFarmSourced // New from excel
        }
        ...
        public static string ManureTypesToString(ManureTypes enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.ManureTypes [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static ManureTypes ManureTypesFromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.ManureTypes"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.ManureTypes [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.ManureTypes"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
        ...
        public static string ApplicationMethodToString(ApplicationMethodEnum enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.ApplicationMethod [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static ApplicationMethodEnum ApplicationMethodFromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.ApplicationMethod"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.ApplicationMethod [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.ApplicationMethod"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
            }
        }
        ...
        {
            CalmGentle0To3BeaufortScale = 1,
            Moderate4to5BeaufortScale = 2,
            StrongBreeze6to7BeaufortScale = 3
        }
        ...
        public static string WindSpeedToString(WindSpeed enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.WindSpeed [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static WindSpeed WindSpeedFromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.WindSpeed"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.WindSpeed [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.WindSpeed"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
        ...
        public static string MethodOfIncorporationToString(MethodOfIncorporationEnum enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.MethodOfIncorporation [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static MethodOfIncorporationEnum MethodOfIncorporationFromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.MethodOfIncorporation"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.MethodOfIncorporation [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.MethodOfIncorporation"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
            }
        }
        ...
        {
            NoRainfallWithin6HoursOfSpreading = 1,
            LightRainLessthan5mmWithin6Hours = 2,
            HeavyRainGreaterThan5mmWithin6hours = 3
        }
        ...
        public static string RainfallToString(Rainfall enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.Rainfall [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static Rainfall RainfallFromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.Rainfall"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.Rainfall [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.Rainfall"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
        ...
        public static string ManureCategoryToString(ManureCategory enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.ManureCategory [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static ManureCategory ManureCategoryFromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.ManureCategory"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.ManureCategory [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.ManureCategory"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
        ...
        public enum CropTypeEnum
        {
            ...
            EarlyEstablishedWinterOilseedRape = 4,
            LateEstablishedWinterOilseedRape = 5,
        ...
        public static string CropTypeEnumToString(CropTypeEnum enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.CropTypeEngland [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static CropTypeEnum CropTypeEnumFromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.CropTypeEngland"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.CropTypeEngland [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.CropTypeEngland"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
        ...
        public static string DelayToIncorporationToString(DelayToIncorporationEnum enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.DelayToIncorporation [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static DelayToIncorporationEnum DelayToIncorporationFromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.DelayToIncorporation"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.DelayToIncorporation [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.DelayToIncorporation"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
        ...
        public static string TopsoilMoistureToString(TopsoilMoistureEnum enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.TopSoilMoisture [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static TopsoilMoistureEnum TopsoilMoistureFromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.TopSoilMoisture"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.TopSoilMoisture [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.TopSoilMoisture"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
        ...
        public static string SoilTypeToString(SoilType enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.SoilEngland [" + enumValue.ToString() + "]");
                    }
            }
        }
        ...
        public static SoilType SoilTypeFromString(string enumValue)
        {
            switch (enumValue)
            {
                ...
                default:
                    {
                        // ##HAND_CODED_BLOCK_START ID="Default Enum MannerLib.Enumerations.SoilEngland"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                        throw new Exception("Unknown enumeration value for MannerLib.Enumerations.SoilEngland [" + enumValue + "]");
                        // ##HAND_CODED_BLOCK_END ID="Default Enum MannerLib.Enumerations.SoilEngland"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
                    }
