...
public class ClimateCalculator
{
    ...
    public void GetClimate(ClimateDto climate, int cropTypeID, int topSoilID, int subSoilID, double topSoilAWC, double subSoilAWC, bool hasOwnClimate = false)
    {
        ...
        try
        {
            ...
            // Set the land cover
            if (cropTypeID == (int) MannerLib.Enumerations.CropTypeEnum.Grass)
            {
    ...
    //public void GetClimate(ClimateDto climate, int easting, int northing, int cropTypeID, int topSoilID, int subSoilID, double topSoilAWC, double subSoilAWC, bool hasOwnClimate = false)
    //{
    ...
    //            if (canproc)
    //            {
    //                mcdm.RetrieveClimate(climate, easting, northing);
    //            }
    //        }
